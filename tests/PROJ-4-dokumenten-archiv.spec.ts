...
// E2E tests for PROJ-4: Dokumenten-Archiv
// Tests verify page rendering, tab navigation, upload dialog, and component behavior.
// CRUD tests requiring auth are covered by RLS + unit tests on the validation schema.

test.describe("PROJ-4: Dokumenten-Archiv", () => {
  // AC: Vehicle detail page has Dokumente tab (no longer disabled)
  test("Vehicle detail page renders active Dokumente tab", async ({ page }) => {
    // Navigate to vehicle detail — redirects to login (unauthenticated)
  ...
  // AC: Unauthenticated users cannot access vehicle documents
